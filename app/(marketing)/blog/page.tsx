...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Technical writing from Prodigy on AI pipelines, signal processing, agent dispatch, and the systems behind product intelligence.'
};
    ...
    <main>
      <PageSection variant="muted" pad="md" className="!border-t-0">
        ...
        <p className="prose-muted mt-6 max-w-2xl text-lg leading-relaxed">
          We write about building reliable product pipelines: gathering signal, prioritizing work,
          writing specs, and shipping with agents. Posts are practical notes from teams running
          Prodigy end to end.
        </p>
        <p className="prose-muted mt-6 max-w-2xl text-base leading-relaxed">
          Topics include signal normalisation, feedback clustering at scale, smart ticket and agent
          handoffs, multi-tenant portal design, and running AI reasoning reliably in a production
          pipeline. Want to suggest a topic or collaborate?{' '}
          <Link
            href="/contact"
